...
\begin{description}
    \item[Air Traffic Controller] --- \textit{(Controller, ATC)} --- a person responsible for the air traffic control service on the VATSIM network, issued a controller rating, allowed to control a selected position and logged in in accordance with the VATSIM Global Controller Administration Policy.
