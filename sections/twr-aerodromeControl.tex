\chapter{Procedures for Aerodrome Control Service}\label{ch:twr:proc}
...
\begin{enumerate}
	\item Wind speed
	      \begin{table}[htb]
		      ...
		      \end{tabular}
		      \caption{Runway Selection Preference System}\label{tbl:runwaySelect}
	      \end{table}
...
LPR helicopter performing training and reposition flights are conducted under the call signs Ratovnik ABC (LPRABC), where ABC is the last three letters of the aircraft registration; e.g., SP-HXB --- Ratovnik~HXB~(LPRHXB).
...
\begin{tabular}{r m{8.5cm} m{8.5cm}}
